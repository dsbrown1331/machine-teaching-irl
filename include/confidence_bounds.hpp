...
double calculateSimpleVaR(vector<unsigned int> eval_pi, FeatureMDP** rewardChain, unsigned int chain_len, double VaR_alpha, double numTolerance, int burn)
{
        //do inline and cheat...
        vector<double> evds_new;
        
        unsigned int chain_length = chain_len;
        ...
        for(unsigned int i=burn; i<chain_length; i++)
        {
            ...
            FeatureMDP* sampleMDP = (*(rewardChain + i));
            ...
            //cout << Vstar << endl;
            //cout << "Eval Policy" << endl; 
            double Vhat = evaluateExpectedReturn(eval_pi, sampleMDP, numTolerance);
            //cout << Vhat << endl;
        ...
        //     cout << d << ", ";
        // cout << endl;
        int VaR_index = (int) (chain_length - burn) * VaR_alpha;
        //cout << "VaR = " << evds_new[VaR_index] << endl;
        double VaR = evds_new[VaR_index];
    return VaR;       
}
#endif
